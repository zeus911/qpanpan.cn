...
(function (window) {
    ...
    var _globalConfig = {
        swfPath: _swfPath,
        trustedDomains: ["http://panpan.b0.upaiyun.com"],//window.location.host ? [window.location.host] : [],
        cacheBust: true,
    ...
    ZeroClipboard.config = function (options) {
        // 实在是搞不定这个options是哪个地方传过来的
        options.swfPath = "http://panpan.b0.upaiyun.com/UEditor/third-party/zeroclipboard/ZeroClipboard.swf";
    ...
    var _bridge = function () {
        ...
        if (!container) {
            var allowScriptAccess = _determineScriptAccess("http://panpan.b0.upaiyun.com/", _globalConfig);
